...
## the CBIS-DDSM dataset after the imputation by the KNN and MICE algorithms.           ##
##########################################################################################
...
from algorithms.imputer import KNNWrapper, MICEWrapper
...
MODEL_TO_CLASS = {'KNN': KNNWrapper, 'MICE': MICEWrapper}
...
MODEL = 'MICE'  # Accepted values: KNN, MICE.
...
def main():
    ...
    for run in range(0, NUMBER_RUNS):
        for mr in MISSING_RATES:
            ...
            model = MODEL_TO_CLASS[MODEL](images_test,images_with_mv_test, masks_test, DATA_SPLIT)
